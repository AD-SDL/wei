...
class TestWEI(unittest.TestCase):
    ...
    def test_workflow_replace_locations(self):
        ...
        workflow_config_path = Path("test_pcr_workflow.yaml")
        
        wei = WEI(workcell_config_path,
        ...
        self.assertListEqual(arg_before_replace2["target"], [279.948, 40.849, 75.130, 598.739, 79.208, -916.456])
        ...
        self.assertListEqual(arg_after_replace["source"], [262.550, 20.608, 119.290, 662.570, 0.0, 574.367])
        self.assertListEqual(arg_after_replace["target"], [195.99, 60.21,  92.13,  565.41,   82.24,  -65.25])

        arg_after_replace2 = wei.get_workflows()[wf_id]["workflow"].flowdef[3].args
        self.assertListEqual(arg_after_replace2["source"], [231.788, -27.154, 313.011, 342.317, 0.0, 683.702])
        self.assertListEqual(arg_after_replace2["target"], [279.948, 40.849, 75.130, 598.739, 79.208, -916.456])
